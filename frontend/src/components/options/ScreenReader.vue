<template>   
  <div class="p-2 sm:p-3 bg-[#f1f5f9] border-[#64758b] dark:bg-gray-800 rounded-lg hover:shadow-md transition-shadow duration-300 w-full max-w-full overflow-hidden">     
    <label class="flex items-center cursor-pointer w-full">       
      ...
      <div class="flex-1 min-w-0 mr-2 sm:mr-3">         
        <div class="text-sm sm:text-base md:text-lg text-gray-800 dark:text-white font-medium leading-tight">
          Leitor de ecrã
        </div>         
        <div class="text-xs sm:text-sm text-[#64748b] dark:text-gray-300 leading-tight">
      ...
      <div class="flex items-center flex-shrink-0">         
        ...
        <div class="relative w-10 h-5 sm:w-12 sm:h-6 md:w-14 md:h-7 bg-gray-300 dark:bg-gray-600 rounded-full transition duration-300 ease-in-out" :class="{'bg-blue-500': screenReader}">           
          <div class="absolute left-0.5 top-0.5 bg-white w-4 h-4 sm:w-5 sm:h-5 rounded-full shadow transition duration-300 ease-in-out" :class="{'transform translate-x-5 sm:translate-x-6 md:translate-x-7': screenReader}"></div>         
        </div>       
      </div>     
    </label>               
